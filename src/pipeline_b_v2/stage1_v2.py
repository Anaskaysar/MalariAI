"""
stage1_v2.py -- Stage 1 watershed v2: CLAHE + resolution-aware parameters

Improvements over v1 (src/pipeline_b/stage1_watershed.py)
----------------------------------------------------------
...
Parameter reference
-------------------
  REF_MIN_DIST = 12   # minimum px between watershed seeds @ 1600x1200
  REF_AREA_MIN = 150  # minimum cell area px^2 @ 1600x1200
  REF_AREA_MAX = 8000 # maximum cell area px^2 @ 1600x1200
...
REF_AREA_MAX = 8000   # maximum cell area to accept (px^2)
MORPH_KSIZE  = 3      # morphological opening disk radius
